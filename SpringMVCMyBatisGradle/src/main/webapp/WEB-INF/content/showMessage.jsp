...
<div class="row" style="margin-top:70px">
	...
	<div id="regist-main">
		...
		<form id="registForm" action="updateUser" method="get">
			<ol>
				<li><label for="UserName">用户名： <span
					...
					name="UserName" type="text" value="${user.name}" disabled="true"></li>
				...
				<li><label for="Email">邮箱地址： <span
					...
					type="text" value="${user.email}" disabled="true"></li>

				<label></label>

				<li><label for="Password">密码： <span
						class="kitjs-validator" for="@Password"
						rules="[{notNull:true, message:'密码不能为空'},{minLength:'3',message:'密码长度最少为3位'}]"></span>
				</label> <span class="field-validation-valid" data-valmsg-for="Password"
					data-valmsg-replace="true"></span> <input id="Password"
					name="Password" type="password" value="${user.pass }"></li>
				<label></label>
			</ol>
			<div class="registError"></div>
			<center>
			<input id="submit" type="submit" value="修改密码" class="btn btn-primary">
			</center>
		</form>
	</div>
</body>
